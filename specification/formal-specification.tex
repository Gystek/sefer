\chapter{Formal specification}
 ...
 indicates the \texttt{check} (verification) part. Since $(\Gamma
 \vdash x \underset{\textsc{tc}}{\Rightarrow} \tau) \Longrightarrow
 (\Gamma \vdash x \underset{\textsc{tc}}{\Leftarrow} \tau)$,
 $\Leftrightarrow$ is simply written as $\Rightarrow$.
