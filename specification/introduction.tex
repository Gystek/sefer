...
\begin{multicols*}{2}
  Sefer is a purely functional data-processing language. At the core
  of every Sefer program lie \emph{iterators} and the many iterator
  adapters defined primitively to enable compile-time optimisations
